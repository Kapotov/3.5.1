...
3. Сделайте `vagrant destroy` на имеющийся инстанс Ubuntu. Замените содержимое Vagrantfile следующим:
   ...
   #Ответ: Так как я на винде у меня не удалось именно этот вагрантфайл апнуть, то я решил сделать похожую конфигурацию, чтобы выполнить все следующие пункты
   ![2023-03-05_21-08-16](https://user-images.githubusercontent.com/123774335/222977913-b4e411b7-ea19-4635-8497-125d157cab0b.png)
